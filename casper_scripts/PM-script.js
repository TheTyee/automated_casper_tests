...
casper.then(function(){
	this.wait(20000,function(){
		this.capture('../returned_data/home/images/captured-PM.png');
...
casper.then(function(){
    ...
    //Create a JSON file
	fs.write('../returned_data/home/PM-details.json', listDetails, 'w');
...
casper.then(function(){
    ...
    this.echo(listItems);
	fs.write('../returned_data/home/PM-headlines.json', listItems, 'w');
	this.echo('headlines');
});  //end list headlines
